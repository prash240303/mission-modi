  ...
  return (
    <>
      ...
      <div className="w-full">
          ...
          <div className=" bg-jse-primary-200 flex md:flex-row flex-col">
            <div className="md:block hidden basis-1/2 p-8">
              <Image src="/Logo.svg" className="w-1/3" alt="" width={1000} height={1000} />
            </div>
            <div className="basis-1/2 py-8 px-4">
              <div className="uppercase font-bold text-jse-neutral-600 pb-4 text-[13px]">Contact Us</div>
              <div className="flex flex-row md:gap-24 gap-8">
                <div>
                  <div className="font-bold  text-[16px]">Delhi</div>
                  <div className="text-jse-neutral-400 pt-4 pb-4 text-[16px]">114 East Moti Bagh, Sarai Rohila</div>
                  <div className="font-bold   text-[13px]">+91 0181 500 4127</div>
                </div>
                <div>
                  <div className="font-bold   text-[16px]">Jalandhar</div>
                  <div className="text-jse-neutral-400 pt-4 pb-4">223, New Laxmipura, Div no.3, Jalandhar, Punjab, India, 144004</div>
                  <div className="font-bold   text-[13px]">+91 921 622 0510</div>
                </div>
              </div>
            </div>
          </div>
          {/* Terms And Conditions Section Of Footer */}
          <div className=" bg-jse-primary-200 flex md:flex-row justify-between flex-col text-jse-neutral-600 p-4">
